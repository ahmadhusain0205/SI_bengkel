...
<!-- modal tambah -->
<form action="<?= site_url('Admin/tambah_kasir'); ?>" method="POST">
...
<?php foreach ($kasir as $a) : ?>
  <form action="<?= site_url('Admin/ubah_kasir'); ?>" method="POST">
...
<!-- modal hapus -->
<?php foreach ($kasir as $a) : ?>
  <form action="<?= site_url('Admin/hapus_kasir'); ?>" method="POST">
    <div class="modal fade" id="hapus<?= $a->id; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body">
            Yakin ingin menghapus data kasir dengan nama <b class="text-danger"><?= $a->nama; ?>?</b>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal"><i class="fa-solid fa-circle-xmark"></i> Batal</button>
            <a href="<?= site_url('Admin/hapus_kasir/') . $a->id; ?>" type="button" class="btn btn-danger btn-sm"><i class="fa-solid fa-circle-check"></i> Ya</a>
          </div>
        </div>
      </div>
    </div>
