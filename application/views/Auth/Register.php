            ...
            <div class="p-4">
              ...
              <form action="<?= site_url('Auth/register'); ?>" method="POST">
                ...
                <div class="row">
                  ...
                  <div class="col">
                    <div class="form-group">
                      <input type="number" class="form-control" name="telepon" placeholder="Masukan nomor telepon...">
                ...
                <div class="row mb-3">
                  <div class="col">
                    <select name="id_role" class="form-control">
                      ...
                      <option value="3">Sebagai Kasir</option>
                      <option value="4">Sebagai Mekanik</option>
                    </select>
